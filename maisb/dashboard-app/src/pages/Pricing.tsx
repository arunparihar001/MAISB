...
const plans: Plan[] = [
  ...
  { id: 'pro', name: 'Pro', price: 'Request invoice', features: ['Higher quota', 'Commercial use', 'Dashboard usage', 'Email support', 'Manual billing approval'] },
