...
export const PUBLIC_SITE_URL =
  import.meta.env.VITE_PUBLIC_SITE_URL || import.meta.env.VITE_PUBLIC_BASE_URL || 'https://maisb.app'
export const DASHBOARD_URL =
  import.meta.env.VITE_DASHBOARD_URL || import.meta.env.VITE_APP_BASE_URL || 'https://app.maisb.app'
...
export function isPublicHost(hostname: string): boolean {
  return hostname === 'maisb.app' || hostname === 'www.maisb.app'
}

export function isAppHost(hostname: string): boolean {
  return hostname === 'app.maisb.app'
}
